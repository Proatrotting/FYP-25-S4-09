...
def get_unique_folder_name(base_name: str, parentfolderid: Optional[str], accountid: str, master_db: MasterNodeDB) -> str:
    """
...
def create_single_folder_direct(
    ...
    try:
        ...
        unique_name = get_unique_folder_name(folder_name.strip(), parent_folder_id, account_id, master_db)
