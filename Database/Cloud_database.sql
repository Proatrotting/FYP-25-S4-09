-- Reset database script - drops all tables and reinitializes from scratch
-- This is a complete 1:1 match with Database.sql schema plus test data
...
DROP TABLE IF EXISTS NODE_HEALTH CASCADE;
DROP TABLE IF EXISTS WORKERS CASCADE;
DROP TABLE IF EXISTS REPAIR_JOBS CASCADE;
DROP TABLE IF EXISTS KEY_SHARE CASCADE;
DROP TABLE IF EXISTS FILE_KEYS CASCADE;
DROP TABLE IF EXISTS FRAGMENT_LOCATION CASCADE;
DROP TABLE IF EXISTS NODE_CAPACITY CASCADE;
DROP TABLE IF EXISTS NODE_HEARTBEAT CASCADE;
DROP TABLE IF EXISTS NODE CASCADE;
DROP TABLE IF EXISTS FILE_FRAGMENTS CASCADE;
DROP TABLE IF EXISTS FILE_SEGMENTS CASCADE;
DROP TABLE IF EXISTS FILE_VERSIONS CASCADE;
DROP TABLE IF EXISTS FILE_OBJECTS CASCADE;
DROP TABLE IF EXISTS FOLDER CASCADE;
DROP TABLE IF EXISTS ACCOUNT_ERASURE CASCADE;
DROP TABLE IF EXISTS SYSADMIN_ACCOUNT CASCADE;
DROP TABLE IF EXISTS FREE_ACCOUNT CASCADE;
DROP TABLE IF EXISTS PAID_ACCOUNT CASCADE;
DROP TABLE IF EXISTS ACCOUNT_ROLE CASCADE;
DROP TABLE IF EXISTS ACCOUNT CASCADE;
DROP TABLE IF EXISTS ERASURE_PROFILE CASCADE;
DROP TABLE IF EXISTS ROLES CASCADE;

-- Now recreate with exact schema from Database.sql
...
-- Test user: alice with password 'password123'
-- Hash: $2b$12$JdmL0ny/fUEo7eFWjVolMerM9AWF8Q.VT/tPa9PmvuNBTIYcpKMaq
INSERT INTO ACCOUNT(ACCOUNT_ID, USERNAME, EMAIL, PASSWORD_HASH, ACCOUNT_TYPE) VALUES (
	'a0000000-0000-0000-0000-000000000001', 
	'alice', 
	'alice@example.com',
	'$2b$12$JdmL0ny/fUEo7eFWjVolMerM9AWF8Q.VT/tPa9PmvuNBTIYcpKMaq',
	'FREE'
);

-- Admin user: admin with password 'admin123'
-- Hash: $2b$12$R9h/cIPz0gi.URNNX3kh2OPST9/PgBkqquzi.Ss7KIUgO2t0jWMUm
INSERT INTO ACCOUNT(ACCOUNT_ID, USERNAME, EMAIL, PASSWORD_HASH, ACCOUNT_TYPE) VALUES (
	'a0000000-0000-0000-0000-000000000002', 
	'admin', 
	'admin@example.com',
	'$2b$12$R9h/cIPz0gi.URNNX3kh2OPST9/PgBkqquzi.Ss7KIUgO2t0jWMUm',
	'SYSADMIN'
);
...
INSERT INTO ACCOUNT_ROLE (ACCOUNT_ID, ROLE_NAME) VALUES (
    (SELECT ACCOUNT_ID FROM ACCOUNT WHERE USERNAME = 'alice'), 
    'USER'
);
...
CREATE TABLE FILE_OBJECTS (
    ...
    -- Encryption support columns
    IS_ENCRYPTED BOOLEAN DEFAULT FALSE,
    ENCRYPTION_METADATA JSONB,
    ORIGINAL_FILE_SIZE BIGINT,
    ORIGINAL_FILE_HASH VARCHAR(64),
    -- SSS Key Storage columns
    KEY_STORAGE_URL VARCHAR(255),
    KEY_FRAGMENT_ID VARCHAR(255),
    FOREIGN KEY (ACCOUNT_ID) REFERENCES ACCOUNT(ACCOUNT_ID),
    FOREIGN KEY (FOLDER_ID) REFERENCES FOLDER(FOLDER_ID) ON DELETE SET NULL
);

-- Index for encrypted files
CREATE INDEX IF NOT EXISTS idx_file_objects_encrypted ON FILE_OBJECTS(IS_ENCRYPTED) WHERE IS_ENCRYPTED = true;
